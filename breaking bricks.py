...
class Ball(GameObject):
    ...
    def collide(self, game_objects):
        ...
        for game_object in game_objects:
            if isinstance(game_object, Bricks):
                game_object.hit()
...
class Bricks(GameObject):
    ...
    def __init__(self, canvas, x, y, hits):
        ...
        self.height = 20
        self.hits = hits
        color = Bricks.COLORS[hits]
        item = canvas.create_rectangle(x - self.width / 2,
                                       y - self.height / 2,
                                       x + self.width / 2,
                                       y + self.height / 2,
                                       fill=color, tags='brick')
        super(Bricks, self).__init__(canvas, item)
...
class Game(tk.Frame):
    ...
    def add_brick(self, x, y, hits):
        brick = Bricks(self.canvas, x, y, hits)
